...
<div class="container mx-auto px-4 py-8">
    ...
    <div class="grid gap-8 md:grid-cols-2">
        ...
        <div>
            <h1 class="mb-4 text-3xl font-bold">{artwork.title}</h1>
            {#if artwork.creator}
                <p class="mb-4 text-xl text-gray-600">By {artwork.creator}</p>
            {/if}
            ...
            <div class="space-y-2">
                {#if artwork.medium}
                    <p class="text-gray-600">
                        <span class="font-semibold">Medium:</span> {artwork.medium}
                    </p>
                {/if}
                <p class="text-gray-600">
                ...
                {#if artwork.rights}
                    <p class="text-sm text-gray-500">
                        <span class="font-semibold">Rights:</span> {artwork.rights}
                    </p>
                {/if}
            </div>
        </div>
